...
=====================
Библиотека может использоваться для автоматического формирования графиков трех видов:  
1) Линейный график
...
***
drawPieChart(pathSet, height, width, locId, inputData) – функция отрисовки круговой диаграммы
*	pathSet – путь к файлу с настройками графика. 
*	height, width – размеры блока с графиком.  
*	locId – id DOM-элемента, в котором будет отрисовываться график
*   inputData - данные, переданные напрямую в функцию. 
...
Параметры файла с настройками для круговой диаграммы
-----------------------------------
[JSON-Схема](https://github.com/fadeeva-marina/diplom/blob/master/shemaPie.json)  
[Пример](https://github.com/fadeeva-marina/diplom/blob/master/settPie.json)  
pathData -  путь к файлу с данными  
...
width - ширина блока для отрисовки графика в px  
margin, padding - отступы графика в px  
innerRadius - внутренний радиус в px  
outerRadius - внешний радиус в px  
